...
def get_args():
    ...
    ap.add_argument("--twitter", type=str, default="", help="Ruta edge list Twitter (directed followers)")
    ap.add_argument("--enron",   type=str, default="email-Enron.txt.gz", help="Ruta edge list Enron (undirected)")
    ap.add_argument("--enron-csv", type=str, default="" , help="Ruta CSV Enron (source,target[,weight])")
    #"real/enron/proc_2_enron_edges_all.csv"#, help="Ruta CSV Enron (source,target[,weight])")
