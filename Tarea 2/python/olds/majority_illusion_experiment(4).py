...
def parse_args():
    ...
    parser.add_argument("--N", type=int, default=1000, help="Número de nodos (default: 500)")
    parser.add_argument("--px1", type=float, default=0.05, help="Fracción de nodos activos esperada (default: 0.05)")
    parser.add_argument("--max-rewire-factor", type=int, default=10, help="Factor *M para límite de iteraciones de rewiring (default: 5)")
    parser.add_argument("--tol", type=float, default=0.01, help="Tolerancia en r_kk y rho_kx (default: 0.035)")
    parser.add_argument("--seed", type=int, default=12021974, help="Semilla global (default: 12345)")
    parser.add_argument("--processes", type=int, default=15, help="Procesos en paralelo (default: cpu_count)")
